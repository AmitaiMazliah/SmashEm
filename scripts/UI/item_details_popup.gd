...
const ITEM_ATTACK_BONUS_TEXT = "[font_size=28][color=black]Damage[/color]
{damage}[/font_size]"
const ITEM_HEALTH_BONUS_TEXT = "[font_size=28][color=black]Hitpoints[/color]
{health}[/font_size]"
...
func set_item(player_item: PlayerEquipment):
	...
	_item_description_label.text = player_item.equipment.description
	open()
